...
import com.github.shakelang.shake.assertArrayEquals
import com.github.shakelang.shake.assertType
import com.github.shakelang.shake.parser.node.IfNode
import com.github.shakelang.shake.parser.node.ImportNode
...
class ParserTests {
    ...
    fun testImport() {
        ...
        node = ParserTestUtil.parse("<ImportTest>", "import com.github.shakelang.shake;")
        assertEquals(1, node.children.size)
        assertType(ImportNode::class, node.children[0])
        assertArrayEquals(
            arrayOf("com", "github", "shakelang", "shake"),

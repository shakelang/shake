...
public class VariablePowAssignmentNode extends ValuedNode {

    private final ValuedNode variable;
    private final Node value;
    private final int operatorPosition;

    public VariablePowAssignmentNode(PositionMap map, ValuedNode variable, Node value, int operatorPosition) {
        super(map);

...
val startScripts = tasks.named<CreateStartScripts>("startScripts") {
    ...
    mainClass.set("com.shakelang.shake.shasambly.ShasXKt")
    classPath = classpath

...
object Opcodes {
    ...
    val S_GET_LOCAL: Byte = bGenerateUByte() // Syntax: S_GET_LOCAL, u2 position ; Load a local shorts onto the stack
    val I_GET_LOCAL: Byte = bGenerateUByte() // Syntax: I_GET_LOCAL, u2 position ; Load a local integers onto the stack
    ...
    val S_STORE_LOCAL: Byte =
        bGenerateUByte() // Syntax: S_STORE_LOCAL, u2 position ; Store the top shorts from the stack into local
    val I_STORE_LOCAL: Byte =
        bGenerateUByte() // Syntax: I_STORE_LOCAL, u2 position ; Store the top integers from the stack into local
    ...
    val S_PUSH: Byte = bGenerateUByte() // Syntax: S_PUSH u2 ; Pushes a shorts onto the stack
    val I_PUSH: Byte = bGenerateUByte() // Syntax: I_PUSH u4 ; Pushes an integers onto the stack
    ...
    val S_BIGGER: Byte =
        bGenerateUByte() // Syntax: S_BIGGER ; Calculates a boolean if the second but top shorts is bigger than the top byte
    val I_BIGGER: Byte =
        bGenerateUByte() // Syntax: I_BIGGER ; Calculates a boolean if the second but top integers is bigger than the top byte
    val L_BIGGER: Byte =
    ...
    val D_BIGGER: Byte =
        bGenerateUByte() // Syntax: D_BIGGER ; Calculates a boolean if the second but top doubles is bigger than the top byte

    val B_SMALLER: Byte =
        bGenerateUByte() // Syntax: B_SMALLER ; Calculates a boolean if the second but top byte is smaller than the top byte
    val S_SMALLER: Byte =
        bGenerateUByte() // Syntax: S_SMALLER ; Calculates a boolean if the second but top shorts is smaller than the top byte
    val I_SMALLER: Byte =
        bGenerateUByte() // Syntax: I_SMALLER ; Calculates a boolean if the second but top integers is smaller than the top byte
    val L_SMALLER: Byte =
    ...
    val D_SMALLER: Byte =
        bGenerateUByte() // Syntax: D_SMALLER ; Calculates a boolean if the second but top doubles is smaller than the top byte
    ...
    val S_BIGGER_EQ: Byte =
        bGenerateUByte() // Syntax: S_BIGGER_EQ ; Calculates a boolean if the second but top shorts is bigger or equal than the top byte
    val I_BIGGER_EQ: Byte =
        bGenerateUByte() // Syntax: I_BIGGER_EQ ; Calculates a boolean if the second but top integers is bigger or equal than the top byte
    ...
    val D_BIGGER_EQ: Byte =
        bGenerateUByte() // Syntax: D_BIGGER_EQ ; Calculates a boolean if the second but top doubles is bigger or equal than the top byte
    ...
    val S_SMALLER_EQ: Byte =
        bGenerateUByte() // Syntax: S_SMALLER_EQ ; Calculates a boolean if the second but top shorts is smaller or equal than the top byte
    val I_SMALLER_EQ: Byte =
        bGenerateUByte() // Syntax: I_SMALLER_EQ ; Calculates a boolean if the second but top integers is smaller or equal than the top byte
    ...
    val D_SMALLER_EQ: Byte =
        bGenerateUByte() // Syntax: D_SMALLER_EQ ; Calculates a boolean if the second but top doubles is smaller or equal than the top byte
    ...
    val S_GET_GLOBAL: Byte =
        bGenerateUByte() // Syntax: S_GET_GLOBAL, u4 position ; Get a global shorts at a given position
    ...
    val B_GET_GLOBAL_DYNAMIC: Byte =
        bGenerateUByte() // Syntax: B_GET_GLOBAL ; Get a global byte at a given position (position is the top stack integers)
    val S_GET_GLOBAL_DYNAMIC: Byte =
        bGenerateUByte() // Syntax: S_GET_GLOBAL ; Get a global shorts at a given position (position is the top stack integers)
    val I_GET_GLOBAL_DYNAMIC: Byte =
        bGenerateUByte() // Syntax: I_GET_GLOBAL ; Get a global int at a given position (position is the top stack integers)
    val L_GET_GLOBAL_DYNAMIC: Byte =
        bGenerateUByte() // Syntax: L_GET_GLOBAL ; Get a global long at a given position (position is the top stack integers)
    ...
    val S_NEG: Byte = bGenerateUByte() // Syntax: S_NEG ; Negate the top shorts
    val I_NEG: Byte = bGenerateUByte() // Syntax: I_NEG ; Negate the top integers
    ...
    val D_NEG: Byte = bGenerateUByte() // Syntax: D_NEG ; Negate the top doubles

    val B_ABS: Byte = bGenerateUByte() // Syntax: B_ABS ; Absolute value of the top byte
    val S_ABS: Byte = bGenerateUByte() // Syntax: S_ABS ; Absolute value of the top shorts
    val I_ABS: Byte = bGenerateUByte() // Syntax: I_ABS ; Absolute value of the top integers
    ...
    val D_ABS: Byte = bGenerateUByte() // Syntax: D_ABS ; Absolute value of the top doubles
    ...
    val S_SHR: Byte =
        bGenerateUByte() // Syntax S_SHR ; Shift shorts bits to the right (takes the top byte as number of shifts)
    val I_SHR: Byte =
    ...
    val S_SHL: Byte =
        bGenerateUByte() // Syntax S_SHL ; Shift shorts bits to the left (takes the top byte as number of shifts)
    val I_SHL: Byte =
    ...
    val S_AND: Byte = bGenerateUByte() // Syntax S_SHL ; Combines two shorts's bits using and
    ...
    val S_OR: Byte = bGenerateUByte() // Syntax S_SHL ; Combines two shorts's bits using or
    ...
    val S_XOR: Byte = bGenerateUByte() // Syntax S_SHL ; Combines two shorts's bits using xor

    ...
    FreeSpec(
        {
            ...
            "Parsing of UnsignedLongType should return UnsignedLongType" {
                TypeDescriptor.parse("j") shouldBe TypeDescriptor.UnsignedLongType
            }
            ...
            "Parsing of a DynamicType should return DynamicType" {
                TypeDescriptor.parse("?") shouldBe TypeDescriptor.DynamicType
            }

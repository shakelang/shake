...
class FieldTests : FreeSpec({
    ...
    "test flags" {
        ...
        field = Field(pool, 0, 0b00000000_00000010.toShort(), listOf())
        ...
        field = Field(pool, 0, 0b00000000_00000100.toShort(), listOf())
        field.isPublic shouldBe false
        field.isPrivate shouldBe false
        ...
        field = Field(pool, 0, 0b00000000_00001000.toShort(), listOf())
        field.isPublic shouldBe false
        field.isPrivate shouldBe false
        field.isProtected shouldBe false
        ...
        field = Field(pool, 0, 0b00000000_00010000.toShort(), listOf())
        field.isPublic shouldBe false
        field.isPrivate shouldBe false
        field.isProtected shouldBe false
        field.isStatic shouldBe false
        ...
        field = Field(pool, 0, 0b00000000_00000000.toShort(), listOf())
        field.isPublic shouldBe false
        field.isPrivate shouldBe false
        field.isProtected shouldBe false
        field.isStatic shouldBe false
        ...
        field = Field(pool, 0, 0b00000000_00000011.toShort(), listOf())
        field.isPublic shouldBe true
        field.isPrivate shouldBe true
        field.isProtected shouldBe false
        field.isStatic shouldBe false
        ...
        field = Field(pool, 0, 0b00000000_00000111.toShort(), listOf())
        field.isPublic shouldBe true
        field.isPrivate shouldBe true
        field.isProtected shouldBe true
        field.isStatic shouldBe false
        ...
        field = Field(pool, 0, 0b00000000_00001111.toShort(), listOf())
        field.isPublic shouldBe true
        field.isPrivate shouldBe true
        field.isProtected shouldBe true
        field.isStatic shouldBe true
        ...
        field = Field(pool, 0, 0b00000000_00011111.toShort(), listOf())
        field.isPublic shouldBe true
        field.isPrivate shouldBe true
        field.isProtected shouldBe true
        field.isStatic shouldBe true
        ...
        field = Field(pool, 0, 0b00000000_00011110.toShort(), listOf())
        field.isPublic shouldBe false
        field.isPrivate shouldBe true
        field.isProtected shouldBe true
        field.isStatic shouldBe true
...
class MutableFieldTests : FreeSpec({
    ...
    "test flags" {
        ...
        field = MutableField(pool, 0, 0b00000000_00000010.toShort(), mutableListOf())
        field.isPublic shouldBe false
        field.isPrivate shouldBe true
        field.isProtected shouldBe false
        field.isStatic shouldBe false
        ...
        field = MutableField(pool, 0, 0b00000000_00000100.toShort(), mutableListOf())
        field.isPublic shouldBe false
        field.isPrivate shouldBe false
        field.isProtected shouldBe true
        field.isStatic shouldBe false
        ...
        field = MutableField(pool, 0, 0b00000000_00001000.toShort(), mutableListOf())
        field.isPublic shouldBe false
        field.isPrivate shouldBe false
        field.isProtected shouldBe false
        field.isStatic shouldBe true
        ...
        field = MutableField(pool, 0, 0b00000000_00010000.toShort(), mutableListOf())
        field.isPublic shouldBe false
        field.isPrivate shouldBe false
        field.isProtected shouldBe false
        field.isStatic shouldBe false
        ...
        field = MutableField(pool, 0, 0b00000000_00000000.toShort(), mutableListOf())
        field.isPublic shouldBe false
        field.isPrivate shouldBe false
        field.isProtected shouldBe false
        field.isStatic shouldBe false
        ...
        field = MutableField(pool, 0, 0b00000000_00000011.toShort(), mutableListOf())
        field.isPublic shouldBe true
        field.isPrivate shouldBe true
        field.isProtected shouldBe false
        field.isStatic shouldBe false
        ...
        field = MutableField(pool, 0, 0b00000000_00000111.toShort(), mutableListOf())
        field.isPublic shouldBe true
        field.isPrivate shouldBe true
        field.isProtected shouldBe true
        field.isStatic shouldBe false
        ...
        field = MutableField(pool, 0, 0b00000000_00001111.toShort(), mutableListOf())
        field.isPublic shouldBe true
        field.isPrivate shouldBe true
        field.isProtected shouldBe true
        field.isStatic shouldBe true
        ...
        field = MutableField(pool, 0, 0b00000000_00011111.toShort(), mutableListOf())
        field.isPublic shouldBe true
        field.isPrivate shouldBe true
        field.isProtected shouldBe true
        field.isStatic shouldBe true
        ...
        field = MutableField(pool, 0, 0b00000000_00011110.toShort(), mutableListOf())
        field.isPublic shouldBe false
        field.isPrivate shouldBe true
        field.isProtected shouldBe true
        field.isStatic shouldBe true
    ...
    "test equals" {
        ...
        val field3 = MutableField(pool, 1, 0, mutableListOf())
        val field4 = MutableField(pool, 0, 1, mutableListOf())
        val field5 = MutableField(pool, 1, 1, mutableListOf())

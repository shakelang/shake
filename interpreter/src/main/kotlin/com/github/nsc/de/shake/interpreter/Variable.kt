...
(
     ...
     * @author [Nicolas Schmidt &lt;@nsc-de&gt;](https://github.com/nsc-de)
     */
    constructor(identifier: String, type: Class<*>, value: InterpreterValue) :
     ...
     * @author [Nicolas Schmidt &lt;@nsc-de&gt;](https://github.com/nsc-de)
     */
    constructor(identifier: String, access: AccessDescriber, type: Class<*>, finalVariable: Boolean) :
     ...
     * @author [Nicolas Schmidt &lt;@nsc-de&gt;](https://github.com/nsc-de)
     */
    constructor(identifier: String, type: Class<*>) : this(identifier, AccessDescriber.PACKAGE, type)
    ...
    companion object {
        ...
        fun create(
            ...
            return when (type.type) {
                VariableType.Type.BYTE, VariableType.Type.SHORT, VariableType.Type.INTEGER, VariableType.Type.LONG ->
                    Variable(
                    name, access, IntegerValue::class.java, value?.to(
                        IntegerValue::class.java
                    ), finalVariable
                )
                VariableType.Type.FLOAT, VariableType.Type.DOUBLE -> Variable(
                    name, access, DoubleValue::class.java, value?.to(
                        DoubleValue::class.java
                    ), finalVariable
                )
                VariableType.Type.BOOLEAN -> Variable(
                    name, access, BooleanValue::class.java, value?.to(
                        BooleanValue::class.java
                    ), finalVariable
                )
                VariableType.Type.OBJECT -> Variable(
                    name, access, ObjectValue::class.java, value?.to(
                        ObjectValue::class.java
                    ), finalVariable
                ) // TODO object-subtypes
                VariableType.Type.DYNAMIC -> Variable(
                    name, access, InterpreterValue::class.java, value?.to(
                        InterpreterValue::class.java
                    ), finalVariable
                )
                VariableType.Type.CHAR -> Variable(
                    name, access, CharacterValue::class.java, value?.to(
                        CharacterValue::class.java
                    ), finalVariable
                )
                VariableType.Type.ARRAY -> throw Error("Not implemented yet")
                else -> throw Error(String.format("Wrong input: %s", type.type))
            }
        }
        ...
        fun finalOf(name: String, v: InterpreterValue): Variable =
                    Variable(name, AccessDescriber.PUBLIC, v.javaClass, v)
    }
}
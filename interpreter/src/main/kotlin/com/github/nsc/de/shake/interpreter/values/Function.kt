...
(
    ...
    override fun invoke(node: FunctionCallNode, scope: Scope): InterpreterValue {
        ...
        for (i in args.indices) {
            ...
            //
            functionScope.scopeVariables.declare(Variable(args[i].name, InterpreterValue::class.java))
    ...
    override fun toString(): String {
        ...
        return String.format(
            "Function{access=%s,isFinal=%s,args=%s,body=%s}", access, isFinal, args.contentToString(), body
        )
    }
}
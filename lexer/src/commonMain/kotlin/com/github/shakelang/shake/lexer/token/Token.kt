package com.github.shakelang.shake.lexer.token


/**
 * The input of the [com.github.shakelang.shake.lexer.Lexer] gets converted into [Token]s. These get parsed
 * by the parser
 *
 ...
 */(
    ...
    val value: String?,
    /**
     * The starting [com.github.shakelang.shake.util.characterinput.position.Position] of the [Token]
     *
     * @see Token
     */
    val start: Int,
    /**
     * The ending [com.github.shakelang.shake.util.characterinput.position.Position] of the [Token]
     *
     * @see Token
     */
    val end: Int

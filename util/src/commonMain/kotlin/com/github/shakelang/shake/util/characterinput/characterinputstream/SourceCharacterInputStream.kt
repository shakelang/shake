package com.github.shakelang.shake.util.characterinput.characterinputstream
...
import com.github.shakelang.shake.util.characterinput.position.PositionMaker
...
class SourceCharacterInputStream(
     ...
     * @author [Nicolas Schmidt &lt;@nsc-de&gt;](https://github.com/nsc-de)
     */
    constructor(file: File) : this(from(file, '<'.toString() + file.path + '>'))
    ...
    override fun peek(from: Int, to: Int): String {
        ...
        return if (position + from < source.length && position + to < source.length) this.content.concatToString().substring(

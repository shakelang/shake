...
import com.github.nsc.de.shake.lexer.characterinput.charactersource.CharacterSource.Companion.from
...
class SourceCharacterInputStream(
    ...
    override fun peek(from: Int, to: Int): String {
        ...
        return if (position + from < source.length && position + to < source.length) String(this.content).substring(

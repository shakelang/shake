...
class JsonToken(
    ...
    /**
     * [JsonToken] equals another
     *
     * @author [Nicolas Schmidt &lt;@nsc-de&gt;](https://github.com/nsc-de)
     */
    override fun equals(other: Any?): Boolean {
        if(other !is JsonToken) return false
        if(other === this ||
            (other.start == this.start && other.end == this.end && other.type == this.type && other.value == this.value))
            return true
        return false
    }
...
class JsonTokenInputStream(
    ...
    /**
     * The PositionMap to resolve the [io.github.shakelang.shake.util.characterinput.position.Position]s
     * of the [JsonToken]s
     */
    val map: PositionMap,

...
class ExpansionTests {
    ...
    fun testStreamAsBufferedInputStream() {
        ...
        assertIs<io.github.shakelang.shake.util.io.streaming.input.BufferedInputStream>(bufferedStream)

        val bufferedStream2 = stream.bufferedStream
        assertIs<io.github.shakelang.shake.util.io.streaming.input.BufferedInputStream>(bufferedStream2)
    }

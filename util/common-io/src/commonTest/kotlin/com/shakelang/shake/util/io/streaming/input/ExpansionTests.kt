...
class ExpansionTests {
    ...
    fun testStreamAsBufferedInputStream() {
        ...
        assertIs<com.shakelang.shake.util.io.streaming.input.BufferedInputStream>(bufferedStream)

        val bufferedStream2 = stream.bufferedStream
        assertIs<com.shakelang.shake.util.io.streaming.input.BufferedInputStream>(bufferedStream2)
    }
    ...
    fun testByteArrayBufferedStream() {
        ...
        assertIs<com.shakelang.shake.util.io.streaming.input.BufferedInputStream>(stream)
        assertContentEquals(byteArrayOf(0x01, 0x02, 0x03, 0x04, 0x05), stream.readFully)
    }

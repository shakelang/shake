 ...
 */
inline fun ByteArray.bufferedStream(): io.github.shakelang.shake.util.io.streaming.input.BufferedInputStream =
    io.github.shakelang.shake.util.io.streaming.input.BufferedInputStream(this.inputStream())
 ...
 * @deprecated A buffered stream of a byte array is useless
 */
inline fun List<Byte>.bufferedStream(): io.github.shakelang.shake.util.io.streaming.input.BufferedInputStream =
    io.github.shakelang.shake.util.io.streaming.input.BufferedInputStream(this.inputStream())
...
inline fun CharSequence.byteBufferedStream() =
    io.github.shakelang.shake.util.io.streaming.input.BufferedInputStream(this.byteInputStream())

 ...
 */
inline fun ByteArray.bufferedStream(): BufferedInputStream =
 ...
 * @deprecated A buffered stream of a byte array is useless
 */
inline fun List<Byte>.bufferedStream(): BufferedInputStream =
    BufferedInputStream(this.inputStream())
...
inline fun CharSequence.byteBufferedStream() =
    BufferedInputStream(this.byteInputStream())
